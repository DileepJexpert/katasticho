...
| R-04 | Purchase -> GRN -> bill -> vendor payment | 2 | BUILDING | Source wiring is complete for eligible-supplier PO/GRN creation, PO-linked GRN/bill hand-offs, stock receipt, bill post/delete/void, 3-way match/override, atomic allocated vendor payment, and vendor-credit creation/application through named vendor and unpaid-bill pickers. React runtime, QA, and accounting acceptance are pending. |
