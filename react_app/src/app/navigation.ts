...
export const appRoutes = {
  ...
  rackLocations: '/inventory/rack-locations',
  putawayTasks: '/inventory/putaway-tasks',
  putawayCreate: '/inventory/putaway-tasks/new',
  putawayDetail: (id: string) => `/inventory/putaway-tasks/${id}`,
  serialNumbers: '/inventory/serial-numbers',
  ...
  payrollLaborPayPreview: '/payroll/labor-pay-preview',
  payrollKenyaPaye: '/payroll/kenya-paye',
  payrollTaxDeclaration: '/payroll/tax-declaration',
  hrLeave: '/hr/leave',
  hrAttendance: '/hr/attendance',
  hrBiometric: '/hr/biometric',
  hrShifts: '/hr/shifts',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: 'Warehouse storage labels and rack creation',
        icon: Layers,
        to: appRoutes.rackLocations,
        roles: ['OWNER', 'ADMIN', 'ACCOUNTANT', 'OPERATOR'],
      },
      {
        id: 'inventory.putaway_tasks',
        label: 'Warehouse Putaway',
        description: 'Physical rack placement and confirmation',
        icon: ListChecks,
        to: appRoutes.putawayTasks,
        roles: ['OWNER', 'ADMIN', 'ACCOUNTANT', 'OPERATOR'],
      },
      {
        id: 'inventory.serial_numbers',
        label: 'Serial Numbers',
        description: 'Serial history and warehouse availability',
        icon: Layers,
        to: appRoutes.serialNumbers,
      ...
      },
      {
        ...
        label: 'Trade Schemes',
        description: 'Promotions, free quantities, and scheme preview',
        icon: Tag,
        to: appRoutes.schemes,
        roles: ['OWNER', 'ADMIN', 'ACCOUNTANT', 'OPERATOR', 'VIEWER'],
      },
      {
        id: 'inventory.uoms',
      ...
      },
      {
        ...
        description: 'Replenishment suggestions & reviewed PO drafts',
        icon: Bookmark,
      ...
      },
      {
        ...
        description: 'Supplier-owned stock & sale settlement records',
        icon: Briefcase,
      ...
      },
      {
        ...
        description: 'ZPL/EPL thermal printer code generation',
        icon: Tag,
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: LifeBuoy,
        to: appRoutes.hrHelpdesk,
      },
      {
        id: 'hr.documents',
        label: 'Documents',
        description: 'Employee KYC, identity & expiring credentials',
        icon: BookOpen,
      ...
      },
      {
        id: 'hr.analytics',
        label: 'Analytics',
        description: 'Workforce pulse, headcount & compliance review',
        icon: BarChart3,
        to: appRoutes.hrAnalytics,
      },
      {
        id: 'hr.offboarding',
        label: 'Offboarding',
        ...
        icon: UserMinus,
        to: appRoutes.hrOffboarding,
      },
      {
        id: 'hr.my_profile',
        label: 'My Profile',
        description: 'Personal info, family dependents & qualifications',
        icon: UsersRound,
        to: appRoutes.hrMyProfile,
      },
      {
        id: 'hr.tax_declaration',
        label: 'Tax Declaration',
        description: 'Form 12BB tax regime & investment declarations',
        icon: ReceiptText,
        to: appRoutes.payrollTaxDeclaration,
      },
      {
        id: 'payroll.runs',
        label: 'Payroll Runs',
      ...
      },
      {
        ...
        description: 'Shopfloor piece-rate & hourly wage estimate',
        icon: TrendingUp,
        to: appRoutes.payrollLaborPayPreview,
        roles: ['OWNER', 'ADMIN', 'ACCOUNTANT'],
      },
      {
        id: 'payroll.settings',
      ...
      },
      {
        ...
        description: 'KRA statutory deductions & net salary simulation',
        icon: Calculator,
        to: appRoutes.payrollKenyaPaye,
        roles: ['OWNER', 'ADMIN', 'ACCOUNTANT'],
        countries: ['KE'],
      },
    ],
