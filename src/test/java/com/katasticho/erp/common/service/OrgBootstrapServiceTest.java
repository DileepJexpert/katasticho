...
class OrgBootstrapServiceTest {
    ...
    void bootstrap_freshOrg_allSeedersRunInOrder() {
        ...
        when(accountService.seedFromTemplate(eq(orgId), eq("TRADING"), nullable(String.class))).thenReturn(SeedResult.CREATED_NEW);
        ...
        order.verify(accountService).seedFromTemplate(eq(orgId), eq("TRADING"), nullable(String.class));
    ...
    void bootstrap_existingOrg_idempotent_noDuplicates() {
        ...
        when(accountService.seedFromTemplate(eq(orgId), eq("TRADING"), nullable(String.class))).thenReturn(SeedResult.ALREADY_EXISTS);
        ...
        verify(accountService, times(2)).seedFromTemplate(eq(orgId), eq("TRADING"), nullable(String.class));
    ...
    void bootstrapAll_mixedResults_correctCounts() {
        ...
        when(accountService.seedFromTemplate(eq(orgId2), eq("RETAIL"), nullable(String.class))).thenReturn(SeedResult.REPAIRED_PARTIAL);
        ...
        when(accountService.seedFromTemplate(eq(orgId3), eq("SERVICES"), nullable(String.class))).thenReturn(SeedResult.CREATED_NEW);
